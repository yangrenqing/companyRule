...
- 服务层仓储边界测试已创建：`src/test/java/com/companyrule/performance/application/PerformanceCycleServiceTest.java`，当前已覆盖 cycle readback、plan readback，以及缺失 cycle 时的 plan-generation failure path
