...
- 首批接口测试已创建：`src/test/java/com/companyrule/performance/api/PerformanceCycleControllerTest.java`，当前已覆盖 create/get/plan-generation 主路径、create/readback 初始时间戳一致性、缺失实体失败，以及 cycle create 的必填/空白字段校验
