...
class PerformanceCycleControllerTest {
    ...
    @Test
    void getCycleFailsClearlyForUnsupportedAcceptType() throws Exception {
    ...
    @Test
    void createCycleFailsValidationForMalformedJson() throws Exception {
        mockMvc.perform(post("/api/performance/cycles")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {
    ...
    @Test
    void createCycleFailsValidationForEmptyRequestBody() throws Exception {
        mockMvc.perform(post("/api/performance/cycles")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(""))
                .andExpect(status().isBadRequest())
    ...
    @Test
    void createCycleFailsValidationForNumericNameField() throws Exception {
        mockMvc.perform(post("/api/performance/cycles")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {
    ...
    @Test
    void createCycleFailsValidationForNumericOrganizationIdField() throws Exception {
        mockMvc.perform(post("/api/performance/cycles")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {
    ...
    @Test
    void createCycleFailsClearlyForUnsupportedHttpMethod() throws Exception {
        mockMvc.perform(put("/api/performance/cycles")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {
                                  "name": "2026 Mid-Year Review",
    ...
    @Test
    void planGenerationFailsClearlyForUnsupportedAcceptType() throws Exception {
        String cycleId = createCycleAndReturnId();
