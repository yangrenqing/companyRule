...
- Added the first controller test suite for create/read/plan-generation behavior, including initial timestamp consistency across cycle create/readback, missing-entity failures, and request-validation coverage for blank or missing required fields.
