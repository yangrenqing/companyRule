...
- [ ] create cycle rejects unsupported `Accept` headers such as `application/xml` with the standard 406 error payload (`timestamp`, `status`, `error`, `message`)
- [ ] create cycle fails clearly for a missing organization with the standard 400 error payload (`timestamp`, `status`, `error`, `message`)
- [ ] plan generation rejects unsupported `Accept` headers such as `application/xml` with the standard 406 error payload (`timestamp`, `status`, `error`, `message`)
